...
const ProjectSinglePage = (props) => {
    ...
    const projectDetails = Projects.find(item => item.slug3 === router.query.slug3)
        ...
        <Fragment>
            ...
            <section className="wpo-portfolio-single-section section-padding">
                <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="portfolio-grids gallery-container clearfix">
                                        <Gallery >
                                            {Projects.slice(3, 6).map((project, pitem) => (
                    ...
                    <div className="pagi">
                        <ul>
                            <li><Link onClick={ClickHandler} href='/project/[slug]' as={`/project/Maria-Nevela`}><i className="fi flaticon-left-arrow"></i> Previous</Link></li>
                            <li><Link onClick={ClickHandler} href='/project/slug2' as={`/project/Maria-Robin`}>Next <i className="fi flaticon-right-arrow-1"></i></Link></li>
                        </ul>
                    </div>
                </div>
            </section>
