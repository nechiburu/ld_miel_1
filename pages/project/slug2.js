...
const ProjectSinglePage = (props) => {
    ...
    const projectDetails = Projects.find(item => item.slug2 === router.query.slug2)
        ...
        <Fragment>
            ...
            <section className="wpo-portfolio-single-section section-padding">
                <div className="container">
                    ...
                    <div className="pagi">
                        <ul>
                            <li><Link onClick={ClickHandler} href='/project/slug3' as={`/project/Rose-Harry`}><i className="fi flaticon-left-arrow"></i> Previous</Link></li>
                            <li><Link onClick={ClickHandler} href='/project/[slug]' as={`/project/Maria-Nevela`}>Next <i className="fi flaticon-right-arrow-1"></i></Link></li>
                        </ul>
                    </div>
                </div>
            </section>
