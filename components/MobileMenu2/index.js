                        ...
                        {menus.map(item => {
                            return (
                                <li key={item.id}>
                                    ...
                                    </p> : <NavLink onClick={ClickHandler} href={item.link}>{item.title}</NavLink>}
                                    {item.submenu ?
                                            ...
                                            <CardBody>
                                                <ul>
                                                    {item.submenu.map(submenu => (
                                                        <li key={submenu.id}><NavLink onClick={ClickHandler} className="active" href={submenu.link}>{submenu.title}</NavLink></li>
                                                    ))}
                                                </ul>
                                            </CardBody>
                                        </Card>
